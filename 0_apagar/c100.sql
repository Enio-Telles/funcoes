...
BASE AS (
    SELECT
        ...
        CASE c100.ind_emit WHEN '0' THEN '0 - Emissão própria' WHEN '1' THEN '1 - Terceiros' END AS ind_emit_desc,
        ...
        CASE c100.ind_pgto WHEN '0' THEN '0 - a vista' WHEN '1' THEN '1 - a prazo' WHEN '2' THEN '2 - outros' WHEN '9' THEN '9 - Sem pagamento' END AS ind_pgto_desc,
        c100.vl_desc                                                 AS vl_desc,
        c100.vl_abat_nt                                              AS vl_abat_nt,
        c100.vl_merc                                                 AS vl_merc,
        CASE c100.ind_frt WHEN '0' THEN '0 - Emitente' WHEN '1' THEN '1 - Destinatário' WHEN '2' THEN '2 - Terceiros' WHEN '9' THEN '9 - Sem frete' END AS ind_frt_por_conta_de,
    ...
    INNER JOIN ARQUIVOS_VALIDOS_FINAIS arq 
